...
unsigned int nTargetSpacing = 1.5 * 60; // 90 seconds
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Aerocoin Launch 6/27";
        CTransaction txNew;
        txNew.nTime = 1403589984;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xa2e9d42d25b5448dfd3507513a7c846b0551c2b3e93fc0e142e3c958ad3772a0"));
        block.print();
